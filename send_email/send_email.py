# found and modified from https://stackoverflow.com/questions/37201250/sending-email-via-gmail-python
import httplib2
import os
import oauth2client
...
def main():
    ...
    #SendMessage(args.sender, args.to, args.subject, msgHtml, msgPlain)
    print(args.to)
    print(args.sender)
